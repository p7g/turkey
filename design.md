...
### 5.5 Specialization (SPEC-DELTAS.md 51)
...
The specialized program is checked by the same checker, on every compile. It is not a different language: it is Core with fewer type abstractions in it.
